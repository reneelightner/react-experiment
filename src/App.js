        ...
        componentSelected === "Component 1" && 
          <div className='col-8'>
            ...
            <Scatterplot 
              ...
              id={'scatterplot'} 
              height={200} 
              margin={{top: 1, right: 15, bottom: 20, left: 20}} 
              ydomain={ydomainscatterplot} 
              xdomain={xdomainscatterplot} 
              ykey={'AWARD'} 
              xkey={'YEAR'} 
              ttkey={'ARTIST'} 
              color={"#fc8d59"} />
        ...
        componentSelected === "Component 2" && 
          <div className='col-6'>
            ...
            <Bar 
              ...
              ydomain={ydomainhorizbar} xdomain={xdomainhorizbar} 
              ykey={'product'} 
              xkey={'sales'} 
              color={"#fc8d59"}/>
          </div>
        ...
        componentSelected === "Component 3" && 
          <div className='col-6'>
            ...
            <Bar 
              ...
              ydomain={ydomainvertbar} 
              xdomain={xdomainvertbar} 
              ykey={'sales'} 
              xkey={'product'} 
              color={"#fc8d59"}/>
          </div>
        ...
        componentSelected === "Component 4" && 
          <div className='col-6'>
            ...
            <StackedBar 
              ...
              ydomain={ydomainhorizstackedbar} 
              xdomain={xdomainhorizstackedbar} 
              ykey={"category"} 
              xkey={'value'} 
        ...
        componentSelected === "Component 5" && 
          <div className='col-6'>
            ...
            <StackedBar 
              ...
              height={200} 
              margin={{ top: 5, right: 5, bottom: 10, left: 20 }} 
              ydomain={ydomainvertstackedbar} 
              xdomain={xdomainvertstackedbar} 
              ykey={"value"} 
              xkey={"category"} 
              categoriescolor={categoriesforcolor} 
              colorkey={"Product"} 
